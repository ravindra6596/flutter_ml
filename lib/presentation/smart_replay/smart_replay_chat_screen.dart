...
class SmartReplayChatScreen extends StatefulWidget {
  const SmartReplayChatScreen({super.key});

  @override
  State<SmartReplayChatScreen> createState() => _SmartReplayChatScreenState();
}

class _SmartReplayChatScreenState extends State<SmartReplayChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: smartReplayChatText),
      body: BlocProvider(
        create: (context) => SmartReplayChatBloc(),
        child: BlocBuilder<SmartReplayChatBloc, SmartReplayState>(
          builder: (context, state) {
            final bloc = context.read<SmartReplayChatBloc>();
            return Column(
              ...
              children: [
                ...
                if (state is SmartReplayChatLoaded) ...[
                  Expanded(
